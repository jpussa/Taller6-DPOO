...
public class PanelDetallesRestaurante extends JPanel
{
    ...
    public PanelDetallesRestaurante() 
    {
        ...
        // Configurar etiqueta para el nombre
        labNombre = new JLabel("Nombre: ");
        add(labNombre);

        // Configurar etiqueta para la calificación
        labCalificacion = new JLabel("Calificación: ");
        add(labCalificacion);

        // Configurar checkbox para el estado de visitado
        chkVisitado = new JCheckBox("Visitado");
        chkVisitado.setEnabled(false); // Solo informativo, no editable
        add(chkVisitado);
