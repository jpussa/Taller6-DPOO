...
public class VentanaPrincipal extends JFrame
{
    ...
    {
    	List<Restaurante> restaurantes = this.mundo.getRestaurantes(true);
    ...
    {
    	Restaurante Restaurantenueva = new Restaurante(nombre,calificacion,x,y,visitado);
    	mundo.agregarRestaurante(Restaurantenueva);
    	actualizarRestaurantes();
     ...
     */
    //Convoca la lista de restaurantes, y la actualiza en la interfaz con la funcion ya hecha para esto (si la lista esta vacia se seleciona el primer valor)
